...
xcodebuild -project "Activity03RepairLoop.xcodeproj" -scheme "Activity03RepairLoop" -destination "platform=iOS Simulator,name=$DEVICE" -derivedDataPath "${TMPDIR:-/tmp}/Activity03RepairLoop-DerivedData" CODE_SIGNING_ALLOWED=NO test
