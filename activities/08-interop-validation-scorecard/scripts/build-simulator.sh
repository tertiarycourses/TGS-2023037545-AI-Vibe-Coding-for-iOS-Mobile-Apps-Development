...
xcodebuild -project "Activity08Evidence.xcodeproj" -scheme "Activity08Evidence" -destination "platform=iOS Simulator,name=$DEVICE" -derivedDataPath "${TMPDIR:-/tmp}/Activity08Evidence-DerivedData" CODE_SIGNING_ALLOWED=NO build
