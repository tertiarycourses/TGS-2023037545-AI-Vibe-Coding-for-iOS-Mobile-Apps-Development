...
xcodebuild -project "Activity04QualityGate.xcodeproj" -scheme "Activity04QualityGate" -destination "platform=iOS Simulator,name=$DEVICE" -derivedDataPath "${TMPDIR:-/tmp}/Activity04QualityGate-DerivedData" CODE_SIGNING_ALLOWED=NO test
