...
xcodebuild -project "BudgetBuddy.xcodeproj" -scheme "BudgetBuddy" -destination "platform=iOS Simulator,name=$DEVICE" -derivedDataPath "${TMPDIR:-/tmp}/BudgetBuddy-DerivedData" CODE_SIGNING_ALLOWED=NO test
