...
xcodebuild -project "HabitPulse.xcodeproj" -scheme "HabitPulse" -destination "platform=iOS Simulator,name=$DEVICE" -derivedDataPath "${TMPDIR:-/tmp}/HabitPulse-DerivedData" CODE_SIGNING_ALLOWED=NO test
