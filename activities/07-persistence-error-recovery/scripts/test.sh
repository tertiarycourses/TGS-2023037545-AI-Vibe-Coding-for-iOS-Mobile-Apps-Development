...
xcodebuild -project "Activity07Recovery.xcodeproj" -scheme "Activity07Recovery" -destination "platform=iOS Simulator,name=$DEVICE" -derivedDataPath "${TMPDIR:-/tmp}/Activity07Recovery-DerivedData" CODE_SIGNING_ALLOWED=NO test
